...
object_attributes = table[table["Object type"] == "unit_combination"].reset_index().iloc[:, 1:]
...
(unit_combination:marginal_cost)=
### marginal_cost
...
(unit_combination:average_cost)=
### average_cost
Average production cost for a combination of generators corresponding to a certain production level of the unit combination. The result is generated by the best_profit module. (xUnit: M3/S, yUnit: NOK/MW)
