...
|   |   |
|---|---|
|Input connections|<a href="generator.html">generator</a>|
|Output connections|<a href="generator.html">generator</a>|
...
object_attributes = table[table["Object type"] == "gen_reserve_capability"].reset_index().iloc[:, 1:]
