...
|   |   |
|---|---|
|Input connections|<a href="reservoir.html">reservoir</a>|
|Output connections|<a href="reservoir.html">reservoir</a>|
|License|SHOP_OPEN|
...
object_attributes = table[table["Object type"] == "volume_constraint"].reset_index().iloc[:, 1:]
