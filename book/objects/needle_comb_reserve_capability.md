...
|   |   |
|---|---|
|Input connections|<a href="needle_combination.html">needle_combination</a>|
|Output connections|<a href="needle_combination.html">needle_combination</a>|
...
object_attributes = table[table["Object type"] == "needle_comb_reserve_capability"].reset_index().iloc[:, 1:]
...
(needle_comb_reserve_capability:reserve_type_name)=
### reserve_type_name
...
### p_extended
Defines an extended production limit for delivering this reserve type. It should be higher than the maximum needle_combination production for upward reserves or below the minimum needle_combination production for downward reserves. (xUnit: NO_UNIT, yUnit: MW)
